// Lead-classification queue message builder. Ported verbatim from the Azure
// Functions lib (api/src/lib/classify-queue.ts) — pure, no Azure dependency.
// The schema (schemaVersion 1) is the contract the n8n consumer parses; do not
// change its shape without updating the consumer.
