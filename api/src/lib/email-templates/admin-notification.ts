import type { ContactFormData } from "../email.js";
...
<head>
    ...
    <style>
        ...
        .detail-value { color: #6b7280; flex-grow: 1; }
        .message-section {
        ...
        .technical-info h3 { margin-top: 0; margin-bottom: 10px; color: #374151; font-size: 16px; }
        .tech-detail { margin-bottom: 5px; color: #6b7280; }
        .actions {
        ...
        .actions h3 { color: #065f46; margin-top: 0; margin-bottom: 15px; }
        .actions ul { color: #047857; margin: 0; padding-left: 20px; }
        .footer {
            text-align: center;
            padding-top: 20px;
