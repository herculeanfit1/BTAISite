...
| Dependency majors — the "Later" trigger (a real test gate exists) is now **met**                                                | 🔄 **In progress 2026-07-30.** 20 majors available. Order per this file: test-only first, Next 16 last. `@types/node` done (it was a live mismatch, not an upgrade). |
